                ...
                <div className="relative">
                  ...
                  <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 transition-all duration-300 ${activePopup === index ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}>
                    ...
                    <a 
                      ...
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className={`absolute w-12 h-12 bg-[#181717] rounded-full flex items-center justify-center text-white hover:scale-110 transition-all duration-500 shadow-lg ${activePopup === index ? 'translate-y-0 -translate-x-[110px] md:-translate-x-[25px] md:translate-y-[65px] scale-100' : 'translate-x-0 translate-y-0 scale-50 opacity-0'}`}

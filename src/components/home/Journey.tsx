...
const steps = [
  ...
  {
    id: 2,
    title: 'Sosialisasi Program Study Club',
    date: '5 Juli 2026',
    side: 'left',
    bg: '#705DF2',
  },
  {
    id: 3,
    title: 'Masa Pendaftaran Peserta',
    date: '5 – 15 Juli 2026',
    side: 'right',
  ...
  {
    id: 4,
    title: 'Pendaftaran Study Club Batch 2',
  ...
  {
    id: 5,
    title: 'Opening Ceremony & Pelaksanaan Acara',
...
export default function Journey() {
  return (
    <>
      ...
      <section
        id="journey"
        className="relative w-full bg-[#01031A] py-16 md:py-24 flex flex-col items-center overflow-hidden"
      >

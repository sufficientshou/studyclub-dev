...
const tracksData = [
  {
    ...
    paragraphs: [
      <p key="1">
        ...
        <span className="text-white font-bold text-xl mr-2">Design</span>
        berfokus pada pembuatan tampilan aplikasi atau website agar menarik dan nyaman digunakan.
      </p>,
      <p key="2">
        <span className="text-white font-semibold">Di bidang ini</span> kamu akan belajar desain interface, pemilihan warna, layout, wireframe, dan prototype menggunakan Figma.
      </p>,
      <p key="3">
        <span className="text-white font-semibold">Cocok buat</span> kamu yang suka desain, kreativitas, dan dunia digital.
      </p>
    ],
    icon: (
  ...
  },
  {
    ...
    paragraphs: [
      <p key="1">
        ...
        <span className="text-white font-bold text-xl mr-2">Development</span>
        adalah bidang yang mempelajari pembuatan website dan aplikasi berbasis web.
      </p>,
      <p key="2">
        <span className="text-white font-semibold">Di bidang ini</span> kamu akan belajar bahasa pemrograman seperti HTML, CSS, dan JavaScript untuk membuat website interaktif.
      </p>,
      <p key="3">
        <span className="text-white font-semibold">Cocok buat</span> kamu yang suka logika, coding, dan problem solving.
      </p>
    ],
    icon: (
  ...
  },
  {
    ...
    paragraphs: [
      <p key="1">
        ...
        <span className="text-white font-bold text-xl mr-2">Science</span>
        adalah bidang yang mempelajari cara mengolah dan menganalisis data untuk menemukan informasi penting.
      </p>,
      <p key="2">
        <span className="text-white font-semibold">Di bidang ini</span> kamu akan belajar pemrograman Python, statistika, dan visualisasi data.
      </p>,
      <p key="3">
        <span className="text-white font-semibold">Cocok buat</span> kamu yang suka angka, analisis, dan penyelesaian masalah berbasis data.
      </p>
    ],
    icon: (
    ...
    <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full max-w-4xl mx-auto">
              {tracksData.map((track) => (
                <div 
                  ...
                  className="cursor-pointer flex flex-col items-center text-center p-6 rounded-[24px] bg-[#23355C]/40 backdrop-blur-md border border-white/40 hover:bg-[#23355C]/60 hover:-translate-y-2 transition-all duration-300"
                >
                  <div className="mb-5 h-16 w-16 relative flex items-center justify-center">
                    {track.icon}
                  </div>
                  <h3 className="text-xl font-semibold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-[#A259FF] to-[#FF8A8A]">
                    {track.title}
                  </h3>
                  <p className="text-gray-300 mb-5 text-sm leading-relaxed px-1">
                    {track.shortDesc}
                  </p>
                  <button className="text-[#FF8A8A] font-medium hover:text-white transition-colors mt-auto text-sm">
                    Lihat selengkapnya
                  </button>
                </div>
              ))}
      ...
      {selectedTrack && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div 
            className="relative w-full max-w-[420px] bg-[#16152a] rounded-[24px] overflow-hidden border border-white/10 shadow-2xl animate-in fade-in zoom-in-95 duration-200"
          >

            <div className="absolute -bottom-16 -right-16 opacity-40 z-0 pointer-events-none">
              <Image 
            ...
            <div className="relative z-10 flex flex-col p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-white font-medium text-base">Detail Kelas</h3>
                <button 
              ...
              <div className="flex flex-col gap-4 text-gray-300 text-sm leading-relaxed text-left pb-2">
                {selectedTrack.paragraphs}
              </div>
            </div>
          </div>
        </div>
